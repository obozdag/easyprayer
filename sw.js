...
const staticContentToCache = [
	...
	'app-config.php',
	`css/easy_prayer.css?${ASSET_VERSION}`,
	'css/rb.css',
	'css/fonts/rb.woff',
	...
	'favicon.ico',
	'index.php',
	`js/adhan.umd.js?${ASSET_VERSION}`,
	`js/easyprayer.js?${ASSET_VERSION}`,
	`js/lang.js?${ASSET_VERSION}`,
	`js/moment-timezone-with-data.js?${ASSET_VERSION}`,
	`js/moment-with-locales.min.js?${ASSET_VERSION}`,
