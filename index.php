	...
	<nav id="nav-left">
		...
		<div class="settings">
			<div class="row">
				...
				<select id="country-list" aria-label="Country"></select>
			</div>
			<div class="row city-search-row">
				<label id="city-search-label" for="city-search"></label>
				<div class="city-search-wrap">
					<input type="search" id="city-search" autocomplete="off" role="combobox" aria-autocomplete="list" aria-expanded="false" aria-controls="city-suggestions">
					<ul id="city-suggestions" class="city-suggestions" role="listbox" hidden></ul>
				</div>
			</div>
			<div class="row">
				<label id="saved-locations-label" for="saved-locations"></label>
				<div class="saved-location-controls">
					<select id="saved-locations"></select>
					<button type="button" id="remove-location-btn" class="icon-btn" aria-label="Remove saved city">&times;</button>
				</div>
			</div>
			<div class="row">
			...
			<p id="location-message" class="settings-message" role="status" aria-live="polite"></p>
			<div class="row">
				<label></label>
